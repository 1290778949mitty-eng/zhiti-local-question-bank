...
export async function POST(request:Request) {
  try {
    ...
    const result=await callRecognitionModel({image:body.image,prompt:studioRecognitionPrompt(body.role,body.lesson,body.context||"")+extra+parallelContext,schema:studioRecognitionSchema,schemaName:"teacher_answer_transcription"});
