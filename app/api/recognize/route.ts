...
export async function POST(request: Request) {
  try {
    ...
    let result = mode === "chat_completions" ? await callChatCompletions(base, apiKey, model, prompt, body.image) : await callResponses(base, apiKey, model, prompt, body.image);
